...
import com.adilkhan.projemanage.databinding.ActivityCreateBoardBinding
...
class CreateBoardActivity : BaseActivity() {
    lateinit var bindingCreateBoardActivity : ActivityCreateBoardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingCreateBoardActivity = ActivityCreateBoardBinding.inflate(layoutInflater)
        setContentView(bindingCreateBoardActivity.root)
        ...
        bindingCreateBoardActivity.ivBoardImage.setOnClickListener { view ->
        ...
        bindingCreateBoardActivity.btnCreate.setOnClickListener {
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            try {
                ...
                Glide
                    ...
                    .into(bindingCreateBoardActivity.ivBoardImage) // the view in which the image will be loaded.
            } catch (e: IOException) {
                e.printStackTrace()
            }
        }
    ...
    private fun setupActionBar() {
        ...
        setSupportActionBar(bindingCreateBoardActivity.toolbarCreateBoardActivity)
        ...
        bindingCreateBoardActivity.toolbarCreateBoardActivity.setNavigationOnClickListener { onBackPressed() }
    }
    ...
    private fun createBoard() {
        ...
        val board = Board(
            bindingCreateBoardActivity.etBoardName.text.toString(),
            mBoardImageURL,
            mUserName,
